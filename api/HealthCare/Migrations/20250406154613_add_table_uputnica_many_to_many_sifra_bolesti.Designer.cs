...
namespace HealthCare.Migrations
{
    ...
    [Migration("20250406154613_add_table_uputnica_many_to_many_sifra_bolesti")]
    partial class addtableuputnicamanytomanysifrabolesti
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthCare.Models.Obavijesti", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthCare.Models.Odsjek", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthCare.Models.SifraBolesti", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthCare.Models.UputnicaSifraBolesti", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SifraBolestiId");

                    b.HasIndex("UputnicaId");

                    b.ToTable("UputnicaSifraBolesti");
                });

            modelBuilder.Entity("HealthCare.Models.ZahtjevLijek", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthCare.WebAPI.Models.AuthToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthCare.Models.Obavijesti", b =>
                {
                    b.HasOne("HealthCare.Models.Osoblje", "Osoblje")
                        .WithMany("Obavijesti")
            ...
            modelBuilder.Entity("HealthCare.Models.Uputnica", b =>
                {
                    ...
                    b.HasOne("HealthCare.Models.Odsjek", "Odsjek")
                        .WithMany()
            ...
            modelBuilder.Entity("HealthCare.Models.UputnicaSifraBolesti", b =>
                {
                    b.HasOne("HealthCare.Models.SifraBolesti", "SifraBolesti")
                        .WithMany()
                        .HasForeignKey("SifraBolestiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HealthCare.Models.Uputnica", "Uputnica")
                        .WithMany()
                        .HasForeignKey("UputnicaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SifraBolesti");
            ...
            modelBuilder.Entity("HealthCare.WebAPI.Models.AuthToken", b =>
                {
                    b.HasOne("HealthCare.Models.Korisnik", "Korisnik")
                        .WithMany()
